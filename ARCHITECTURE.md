# Nanobanana MCP Server — Architecture & Reference

This file contains the full architecture documentation and development reference for the nanobanana-mcp-server. It was separated from CLAUDE.md to keep behavioral rules lean. For fork-specific customizations and merge protocol, see `CLAUDE.md` in this directory.
